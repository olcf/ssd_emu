...
class JobsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job" do
    assert_difference("Job.count") do
      post jobs_url, params: { job: { cores: @job.cores, errors: @job.errors, job_reason_code: @job.job_reason_code, machine_id: @job.machine_id, mail_type: @job.mail_type, mail_user: @job.mail_user, nodes: @job.nodes, output: @job.output, projectName: @job.projectName, script: @job.script, state: @job.state, user_id: @job.user_id, walltime: @job.walltime } }, as: :json
    end
